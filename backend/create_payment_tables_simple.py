#!/usr/bin/env python3
"""
Simple script to create payment-related tables in the database.
Uses centralized env-based DB config from scripts_db.
"""
...
def create_payment_tables():
    ...
    try:
        ...
        cursor.execute(booking_addons_table)
        ...
        cursor.execute("SHOW TABLES LIKE 'booking_addons'")
        if cursor.fetchone():
