"""Create all booking-related tables via direct SQL using mysql-connector.
This avoids importing app modules and potential circular imports.
...
def main():
  print(f"Connecting to MySQL {settings.MYSQL_HOST} as {settings.MYSQL_USER} db={settings.MYSQL_DB}")
